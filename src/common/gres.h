...
#define GRES_AUTODETECT_NPU     0x00000003   /* NPU plugin */
 ...
 * OUT avail_gres     - Count of available GPUs or NPUs on this node
 * OUT near_gres      - Count of GPUs or NPUs available on sockets with available CPUs
